...
set header_file ~/STM32CubeIDE/workspace_2.1.1/tflm_h7/CM7/Core/Inc/run_tflm.h
...
cat $input_file | while read -l model
    ...
    $cubeide --launcher.suppressErrors -nosplash -data ~/STM32CubeIDE/workspace_2.1.1 -application org.eclipse.cdt.managedbuilder.core.headlessbuild -cleanBuild tflm_h7_CM7/Release
    ...
    $cubeprogrammer -c port=SWD -w ~/STM32CubeIDE/workspace_2.1.1/tflm_h7/STM32CubeIDE/CM7/Release/tflm_h7_CM7.elf -v -rst
